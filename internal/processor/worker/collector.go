...
// It runs as a single goroutine — no locks needed on the writers.
//
...
func newResultCollector(outputWriter, errorWriter *bufio.Writer, progress *executionProgress, logger logr.Logger) *resultCollector {
